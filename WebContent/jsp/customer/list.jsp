                            ...
                            <TABLE id=grid
                                ...
                                <c:forEach items="${page.beanList}" var="customer">
                                    <TR
                                        ...
                                        <TD>
                                            <a href="${pageContext.request.contextPath }/customer_initUpdate.action?cust_id=${customer.cust_id}">
                                                修改</a>&nbsp;&nbsp;
                        ...
                        <TD><SPAN id=pagelink>
                            <DIV
                                ...
                                <select name="pageSize">
                                    <option value="2" <c:if test="${page.pageSize==1 }">selected</c:if>>2</option>
                                    <option value="3" <c:if test="${page.pageSize==30 }">selected</c:if>>3</option>
                                </select>
                                条
